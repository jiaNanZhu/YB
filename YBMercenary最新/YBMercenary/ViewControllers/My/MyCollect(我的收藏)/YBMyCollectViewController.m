...
//        return cell;
        ...
        if (!cell) {
            ...
            headImageV.layer.cornerRadius = AdFloat(40);
            ...
            [headImageV mas_makeConstraints:^(MASConstraintMaker *make) {
                make.top.equalTo(cell.contentView).offset(AdFloat(30));
                make.left.equalTo(cell.contentView).offset(AdFloat(30));
                make.size.mas_equalTo(CGSizeMake(AdFloat(80), AdFloat(80)));
                
            }];
            
            UILabel *nameLabel = [[UILabel alloc]init];
            nameLabel.textColor = [UIColor hex:@"444444"];
            nameLabel.font = SetFont(AdFloat(30));
            nameLabel.tag = 11;
            [cell.contentView addSubview:nameLabel];
            [nameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
                make.left.equalTo(headImageV.mas_right).offset(AdFloat(30));
        ...
        UIImageView *headImageV = (UIImageView *)[cell.contentView viewWithTag:10];
        [headImageV sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",HOST,model.head_img]] placeholderImage:SetImage(@"Group1")];
