...
@interface ZJNMyIssueBackOrderCell : UITableViewCell
...
@property(nonatomic ,strong)UILabel *infoLabel;//延期原因
@property(nonatomic ,strong)UILabel *dayLabel;//延期天数
@property(nonatomic ,strong)UILabel *dateLabel;//延期日期
