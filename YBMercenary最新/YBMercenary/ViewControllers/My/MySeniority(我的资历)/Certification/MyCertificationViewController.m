...
-(void)makeUI{
    ...
    backView_1.frame = CGRectMake(0, AdFloat(16), d_Device_width, AdFloat(90*3));
    [self.view addSubview:backView_1];
    
    UILabel *lab_1 = [F_UI SL_UI_Label:@"姓名" color:[UIColor hex:@"444444"] textAlignment:NSTextAlignmentLeft textFont:AdFloat(28) numberOfLines:1];
    lab_1.frame = CGRectMake(AdFloat(30), 0, AdFloat(250), AdFloat(91));
    [backView_1 addSubview:lab_1];
    
    numberLab = [F_UI SL_UI_Label:@"请输入姓名" color:[UIColor hex:@"666666"] textAlignment:NSTextAlignmentRight textFont:AdFloat(28) numberOfLines:1];
    ...
    UILabel *lab_2 = [F_UI SL_UI_Label:@"银行卡号" color:[UIColor hex:@"444444"] textAlignment:NSTextAlignmentLeft textFont:AdFloat(28) numberOfLines:1];
    lab_2.frame = CGRectMake(AdFloat(30), AdFloat(90), AdFloat(250), AdFloat(91));
    [backView_1 addSubview:lab_2];
    bankCardLab = [F_UI SL_UI_Label:@"请输入银行卡号" color:[UIColor hex:@"666666"] textAlignment:NSTextAlignmentRight textFont:AdFloat(28) numberOfLines:1];
    bankCardLab.hidden=YES;
    bankCardLab.frame = CGRectMake(d_Device_width-AdFloat(500), AdFloat(90), AdFloat(440), AdFloat(90));
    [backView_1 addSubview:bankCardLab];
    bankcardnumTf =[[UITextField alloc]init];
    bankcardnumTf.frame=bankCardLab.frame;
    bankcardnumTf.returnKeyType=UIReturnKeyDone;
    bankcardnumTf.delegate=self;
    bankcardnumTf.placeholder=@"请输入银行卡号";
    bankcardnumTf.textAlignment=NSTextAlignmentRight;
    [backView_1 addSubview:bankcardnumTf];
    UIImageView *img2 = [F_UI SL_UI_UIimg:[UIImage imageNamed:@"返回-4 copy 6"] cornerRadius:0];
    img2.frame = CGRectMake(d_Device_width-AdFloat(42), AdFloat(33)+AdFloat(90), AdFloat(12), AdFloat(24));
    [backView_1 addSubview:img2];
    
    UILabel *lab_7 = [F_UI SL_UI_Label:@"身份证号" color:[UIColor hex:@"444444"] textAlignment:NSTextAlignmentLeft textFont:AdFloat(28) numberOfLines:1];
    lab_7.frame = CGRectMake(AdFloat(30), AdFloat(90*2), AdFloat(250), AdFloat(91));
    [backView_1 addSubview:lab_7];
    idCardLab = [F_UI SL_UI_Label:@"请输入身份证号" color:[UIColor hex:@"666666"] textAlignment:NSTextAlignmentRight textFont:AdFloat(28) numberOfLines:1];
    idCardLab.hidden=YES;
    idCardLab.frame = CGRectMake(d_Device_width-AdFloat(500), AdFloat(90*2), AdFloat(440), AdFloat(90));
    [backView_1 addSubview:idCardLab];
    idccarnumTf =[[UITextField alloc]init];
    idccarnumTf.frame=idCardLab.frame;
    ...
    UIImageView *img3 = [F_UI SL_UI_UIimg:[UIImage imageNamed:@"返回-4 copy 6"] cornerRadius:0];
    img3.frame = CGRectMake(d_Device_width-AdFloat(42), AdFloat(33)+AdFloat(90*2), AdFloat(12), AdFloat(24));
    [backView_1 addSubview:img3];
    ...
    UILabel *lab_10 = [F_UI SL_UI_Label:@"上传身份证照片" color:[UIColor hex:@"444444"] textAlignment:NSTextAlignmentLeft textFont:AdFloat(28) numberOfLines:1];
    lab_10.frame = CGRectMake(AdFloat(30), AdFloat(24), AdFloat(300), AdFloat(40));
    [backView_2 addSubview:lab_10];
    
    imgBack = [F_UI SL_UI_View:[UIColor hex:@"EDEDED"] cornerRadius:0 borderColor:nil borderWidth:0];
    imgBack.frame = CGRectMake(AdFloat(40), lab_10.maxY+AdFloat(26), d_Device_width-AdFloat(80), AdFloat(360));
    [backView_2 addSubview:imgBack];
    
    
    idcardImg= [[UIImageView alloc]init];
    idcardImg.frame=CGRectMake(AdFloat(40), lab_10.maxY+AdFloat(26), d_Device_width-AdFloat(80), AdFloat(360));
    ...
    UIButton *submitBtn = [F_UI SL_UI_Btn:@"提交" Color:[UIColor whiteColor] Font:AdFloat(32) bgimage:nil selecteImage:nil target:self action:@selector(rightBtn) cornerRadius:AdFloat(45)];
    [submitBtn setBackgroundColor:[UIColor hex:@"0386FF"]];
    [self.view addSubview:submitBtn];
    [submitBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(photographBtn.mas_bottom).offset(AdFloat(30));
        make.centerX.equalTo(self.view);
        make.size.equalTo(photographBtn);
    }];
