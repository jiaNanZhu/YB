...
-(void)makeUI{
    ...
    textField_3 = [F_UI SL_UI_Field:@"请输入新的登录密码" font:AdFloat(28) textAlignment:NSTextAlignmentLeft borderStyle:UITextBorderStyleNone clearOnBeginEditing:YES secure:YES keyBoardStyle:UIKeyboardTypeASCIICapable];
...
//    [affirmBtn setBackgroundColor:[UIColor hex:@"0386FF"]];
    [affirmBtn setBackgroundImage:SetImage(@"nav") forState:UIControlStateNormal];
