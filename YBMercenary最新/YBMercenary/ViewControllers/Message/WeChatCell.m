...
#define DEF_ICON @"Group1"
#define USER_ICON @"40x40pt"
    ...
    if (self) {
        ...
        if (model.messageType==MessageTypeText) {
            ...
            if (model.messageSenderType==MessageSenderTypeHantu) {
                ...
                logoImage.layer.cornerRadius = 20;
                logoImage.layer.masksToBounds = YES;
                [logoImage setImageWithURL:[NSURL URLWithString:model.logoUrl] placeholderImage:[UIImage imageNamed:USER_ICON]];
                [self.contentView addSubview:logoImage];
