...
- (void)creatSubViews{
    ...
    UILabel *valid = [F_UI SL_UI_Label:@"任务有效期 /天" color:[UIColor hex:@"444444"] textAlignment:0 textFont:AdFloat(28) numberOfLines:1];
    [Utile setUILabel:valid data:@"任务有效期" setData:@" /天" color:[UIColor redColor] font:AdFloat(20) underLine:NO];
    ...
    [valid mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_lessThanOrEqualTo(Width(90));
    }];
...
//        NSDate *minDate = [NSDate br_setYear:1990 month:3 day:12];
        ...
        [BRDatePickerView showDatePickerWithTitle:@"选择时间" dateType:BRDatePickerModeYMD defaultSelValue:nil minDate:maxDate maxDate:nil isAutoSelect:YES themeColor:nil resultBlock:^(NSString *selectValue) {
