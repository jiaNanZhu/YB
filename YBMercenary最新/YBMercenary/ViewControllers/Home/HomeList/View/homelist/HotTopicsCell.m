...
@property (nonatomic, strong) PubTypeListModel *model;
@end
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.zoneImageView.clipsToBounds=YES; cell.zoneImageView.contentMode=UIViewContentModeScaleAspectFill;
    [cell.zoneImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",HOST,self.imgs[indexPath.row]]] placeholderImage:[UIImage imageNamed:@"发帖图"]];
    return cell;
}
...
- (void)clickIcon{
    ...
    vc.user_id=self.model.post_user_id;
    vc.hidesBottomBarWhenPushed = YES;
    [self.viewController.navigationController pushViewController:vc animated:YES];
}
...
-(void)configurationcellwithmodel:(PubTypeListModel *)model
{
    ...
    if ([model.post_img isEqualToString:@""]) {
    ...
    [_iconImage sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",HOST,model.post_user_headimg]] placeholderImage:SetImage(@"Group1")];
