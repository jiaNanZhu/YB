...
#import "UserInfoVC.h"
@interface ZJNTaskDoneViewController ()<UITableViewDelegate,UITableViewDataSource,ZJNSignUpBottomViewDelegate,SDPhotoBrowserDelegate>
...
@implementation ZJNTaskDoneViewController
...
-(ZJNSignUpBottomView *)bottomView{
    if (!_bottomView) {
        ...
        [_bottomView.stateBtn setTitle:@"已完成" forState:UIControlStateNormal];
