...
//初始化方法
- (instancetype)initWithChoseSingle:(BOOL)choseSingleImage maxImagesCount:(NSInteger)maxImagesCount delegate:(id<PhotosNavigationControllerDelegate>)delegate;
...
//默认为NO
@property (nonatomic, assign) BOOL choseSingleImage;
...
@property (nonatomic, copy) void (^PhotosNavigationControllerDidCancelHandle)(void);
